...
class Resizer {
    ...
    private $target_width=500;
    private $target_height=500;
    private $bg_color=array('red'=>255,'green'=>255,'blue'=>255);

    const VERTICAL_OFFSET=10;
    const HORIZONTAL_OFFSET=10;

    public function __construct($target_width, $target_height, $bg_color)
    {
    ...
    public function resize($source)
    {
        ...
        $target_img = imagecreatetruecolor($this->target_width, $this->target_height);
        ...
        $ratio=max($real_width/$this->target_width, $real_height/$this->target_height, 1);
        $width=$real_width/$ratio;
        $height=$real_height/$ratio;
        $x=($this->target_width-$width)/2;
        $y=($this->target_height-$height)/2;
        imagecopyresampled(
            $target_img,
            $this->source_img,
            $x, $y,
